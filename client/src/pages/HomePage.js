...
const HomePage = () => {
  ...
  // Filter products based on checked categories and radio value
  ...
  // Effect to fetch categories and total count on initial load
  useEffect(() => {
    getAllCategory();
    getTotal();
  }, []);
  ...
  // Effect to filter products when checked or radio state changes
  useEffect(() => {
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      localStorage.setItem(
                        "cart", //so item dont get lost after refresh
